...
##--------------------------------------------
## Functions for generating the reverse
...
##--------------------------------------------
## do two string approximately match
...
## by Profile. For example, ACGGGGATTACC is the Profile-most probable 12-mer in GGTACGGGGATTACCT.
